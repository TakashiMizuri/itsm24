...
export default function Carousel({ images, itemsToShow = 3, allowModal = true, itemWidth, itemHeight }: Props) {
  ...
  if (itemWidth) (rootStyle as any)['--carousel-item-width'] = itemWidth;
  if (itemHeight) (rootStyle as any)['--carousel-item-height'] = itemHeight;
                ...
                {allowModal ? (
                  ...
                  >
                    <div className={styles.imageWrapper}>
                      <Image src={item.src} alt={item.alt ?? ''} width={1200} height={900} className={styles.carouselImage} priority={index === 0} />
                    </div>
                  </button>
                ) : (
                  <div className={styles.imageWrapper}>
        ...
        <div className={styles.modalOverlay} role="dialog" aria-modal="true" onClick={closeModal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalImageWrapper}>
              <Image src={images[modalIndex].src} alt={images[modalIndex].alt ?? ''} fill sizes="(max-width: 768px) 90vw, 1200px" style={{ objectFit: 'contain' }} priority />
            </div>
