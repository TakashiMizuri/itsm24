                ...
                <nav className={styles.nav}>
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                className={`${styles.dropdownMenu} ${styles.servicesDropdown} ${activeDropdown === 'services' ? styles.active : ''
                                    }`}
                        ...
                        >
                            ...
                            <div
                                className={`${styles.dropdownMenu} ${activeDropdown === 'about' ? styles.active : ''
                                    }`}
                    ...
                    <div className={styles.contactsGrid}>
                        <div className={styles.contactCard}>
                            ...
                            <div className={styles.contactContent}>
                                <p className={styles.contactTitle}>Адрес</p>
                        ...
                        <div className={styles.contactCard}>
                            ...
                            />
                            <div className={styles.contactContent}>
                                <p className={styles.contactTitle}>График работы</p>
                                <p className={styles.contactText}>
