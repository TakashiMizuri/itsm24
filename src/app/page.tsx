...
export default function Home() {
    ...
    return (
        <div className={styles.page}>
            ...
            <main className={`${styles.container} ${isLoading ? styles.loading : ''}`}>
            ...
            <section className={`${styles.companyInfo} ${isLoading ? styles.loading : ''}`}>
                <div className={styles.companyContainer}>
                    <div className={styles.companyContent}>
                        ...
                        <p className={styles.companyDescription}>
                            ...
                            автоматизации бизнес-процессов. Более 5 лет на рынке
                            Красноярска и края.
                        </p>
